...
public class MoviesSyncUtils {
    ...
    static void scheduleJobDispatcherSync(@NonNull final Context context) {
        ...
        Job syncJob = dispatcher.newJobBuilder()
                ...
                .setService(MoviesJobService.class)
                /* Set the UNIQUE tag used to identify this Job */
                .setTag(SYNC_TAG)
                /*
                * Not running on unmetered newtork
                 */
    ...
    synchronized public static void initialize(@NonNull final Context context)
    {
        ...
        /*
         * We need to check to see if our ContentProvider has data to display in our movies
